...
import { FormInput, FormPassword, FormRadio, FormLabel } from '@components';
			...
			<div className="form-wrapper">
				<FormProvider {...form}>
					<form onSubmit={handleSubmit(onSubmit)}>
						...
						<Row>
							<FormLabel
								title={t('registration_course.create.course_type')}
								description="Required"
							/>
							<Right>
								<FormRadio t={t} name="role" options={ROLES_OPTION} />
							</Right>
						</Row>
						<Divider />
