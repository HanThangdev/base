...
export const PUBLISH_COURSE_OPTION = [
	{
		value: 'PUBLIC',
		label: 'course:registration_course.publish_course_option.public',
	},
	{
		value: 'PRIVATE',
		label: 'course:registration_course:publish_course_option.private',
	},
];
...
export const QUESTION_TYPE_SELECT = [
	...
	{
		value: 'CHOOSE_MANY',
		label: 'unit_setting:question_setting.multiple_choice',
	},
	{
		value: 'DESCRIPTION',
		label: 'unit_setting:question_setting.description_choice',
	},
];
...
export const TARGET_RANGE = [
	{
		value: false,
		label: 'auto_assignment_course:create_automatic.condition_specification',
	},
