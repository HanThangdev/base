...
export const useRegistrationCourses = () => {
	...
	const { courses, pagination, filter, isLoading, error }: any = useSelector(
		makeSelectRegistrationCourses()
	);

	const dispatch = useDispatch();
	const loadCoursesAction = (payload?: any) => dispatch(loadCourses(payload));
	const deleteCoursesAction = (payload?: any) =>
...
export const useCreateCourse = () => {
	...
	const { isSubmitting, error }: any = useSelector(
		makeSelectRegistrationCourses()
	);
...
export const useUpdateCourse = () => {
	...
	const { course, isSubmitting, error }: any = useSelector(
		makeSelectRegistrationCourses()
	);
