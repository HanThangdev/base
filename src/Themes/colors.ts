...
export const Colors = {
	...
	bg_dark: '#1f2128',
	bg_blue_white:
		'linear-gradient(180deg, rgba(250, 251, 253, 0.546028) 0.05%, #FEFEFF 84.64%, #FFFFFF 100%)',
	bg_block: '#FAF9F7',
...
export const alpha = (color: any, value: any) =>
	tinycolor(color).setAlpha(value).toRgbString();
