		...
		<ToggleNav visible={visible} className="card shadow-lg">
			<div className="card-header pb-0 pt-3 bg-transparent">
				...
				<div className="float-end mt-4" onClick={() => setVisible(false)}>
					<label className="btn btn-link text-dark p-0" htmlFor="expand-toggle"><i className="fa fa-close fs-6" /></label>
				</div>
				{/* End Toggle Button */}
			</div>
			...
			<div className="card-body pt-sm-3 pt-0">
				...
				<div className="card-wrapper mt-4">
					<div className="d-flex justify-content-between">
						...
						<div><span className="badge bg-gradient-secondary">Ethereum</span></div>
					</div>
					<hr className="horizontal dark my-3 d-xl-block d-none" />
					<div className="d-flex align-items-center">
						<div className="me-3">
							<img src={LOGO_USDT} style={{width: '32px'}} alt="avatar_img"/>
						</div>
						<div className="flex-grow-1">
					...
					<div className="d-flex align-items-center my-2">
						<div className="me-3">
							<img src={LOGO_USDC} style={{width: '32px'}} alt="avatar_img"/>
						</div>
						<div className="flex-grow-1">
					...
					<div className="d-flex align-items-center my-2">
						<div className="me-3">
							<img src={LOGO_BUSD} style={{width: '32px'}} alt="avatar_img"/>
						</div>
						<div className="flex-grow-1">
							<span className="fs-7 font-weight-bolder">BUSD</span>
							<p className="fs-8 text-secondary mt-minus1 mb-1">Binance USD</p>
						</div>
						<div className="text-end">
					...
					<div className="d-flex align-items-center my-2">
						<div className="me-3">
							<img src={LOGO_ETH} style={{width: '32px'}} alt="avatar_img"/>
						</div>
						<div className="flex-grow-1">
					...
					<a className="btn bg-gradient-info w-100 mb-0 mt-3" href="/">Add Funds</a>
				</div>
			</div>
		</ToggleNav>
	 </div>
