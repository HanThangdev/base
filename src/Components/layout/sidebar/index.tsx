		...
		<div className="fixed-plugin w-100 h-100">
          ...
          <div className="w-100 float-start d-flex align-items-center">
            ...
            <div className="flex-grow-1 icon_link" onClick={onLogout}>
              <NavbarIcon><i className="far fa-sign-out-alt" /></NavbarIcon>
            </div>
            <div className="icon_link ms-2" onClick={() => setVisible(false)}>
              <label className="btn btn-link m-0" htmlFor="expand-toggle" ><i className="fa fa-close fs-6 text-secondary" /></label>
            </div>
          </div>
        </div>
        <div className="card-body pt-sm-3 pt-0">
          ...
          <div className="row sidenav-menu">
            ...
            <div className="col-6 ps-0">
              <a href="/"><i className="fa-light fa-id-card" /><span>Account</span></a>
            </div>
            <div className="col-6 pe-0">
              <a href="/"><i className="fa-light fa-chart-pie-simple" /><span>Share NFTs</span></a>
            </div>
            <div className="col-6 ps-0">
              <a href="/"><i className="fa-regular fa-shield-check" /><span>Security</span></a>
            </div>
            <div className="col-6 pe-0">
              <a href="/"><i className="far fa-users" /><span>Referral</span></a>
            </div>
            <div className="col-6 ps-0">
              <a href="/"><i className="fa-regular fa-sliders-up" /><span>Setting</span></a>
            </div>
            <div className="col-6 pe-0">
              <a href="/"><i className="far fa-star" /><span>Add Review</span></a>
            </div>
            <div className="col-6 ps-0">
              <a href="./faq.html"><i className="far fa-question-circle" /><span>FAQ</span></a>
            </div>
          </div>
          {/* Subscription */}
          <div className="card-wrapper mt-3 shadow-sm">
            <div className="d-flex justify-content-between">
              <div className="fs-7 font-weight-bolder"><i className="fa-light fa-rotate fs-5 me-2 font-weight-bold" />Subscription</div>
              <div><button type="button" className="btn bg-gradient-primary btn-sm mb-0">Manage</button></div>
            </div>
            ...
            <div className="text-end">
              <span className="fs-7 font-weight-bolder text-gradient text-primary">January 30th, 2020, 22:00UTC</span>
            </div>
          </div>
          {/* Wallet */}
          <div className="card-wrapper mt-4 shadow-sm">
            <div className="d-flex justify-content-between">
              <div className="fs-7 font-weight-bolder"><i className="fa-regular fa-wallet fs-5 me-2 font-weight-600" />Wallet</div>
              <div><a className="text-gray-600 hover_primary" href="/"><span className="fs-6 font-weight-bolder">$ 4250.25</span><i className="fas fa-external-link-alt ms-2 fs-8" /></a></div>
            </div>
            <hr className="horizontal dark my-3 d-xl-block d-none" />
            ...
            <a className="btn bg-gradient-info w-100 mb-2 mt-3" href="/">Add Funds</a>
            <div className="mt-2 px-2">
              <img alt="" className="w-100" src={LOGO_PAYMENT} style={{width: '32px'}}/>
            </div>
          </div>
        </div>
			</ToggleNav>
